        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-3 lg:row-span-3 flex flex-col gap-4 h-auto bento-labs-parent-height">
          ...
          >
            <div className="space-y-3 sm:space-y-4 lg:space-y-1.5 xl:space-y-3 2xl:space-y-4 h-auto lg:h-full flex flex-col justify-between">
              ...
              <div className="flex-grow flex flex-col justify-between gap-2.5 lg:gap-1 xl:gap-2.5 2xl:gap-3 mt-3 lg:mt-0">
                {curriculumPoints.map((item, idx) => (
                  <div key={idx} className="group rounded-xl bg-slate-950/45 p-2.5 sm:p-3 lg:py-1 lg:px-2.5 xl:p-2.5 2xl:p-3 border border-slate-800/50 hover:border-violet-950/80 transition duration-200">
                    ...
                    <div className="mt-1 lg:mt-0 xl:mt-0.5 text-[10px] sm:text-xs lg:text-[8px] xl:text-[10px] 2xl:text-xs text-slate-400 leading-normal">{item.info}</div>
                  </div>
                ))}
              </div>
            </div>
